...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c6:hover:not(:disabled):not(.obridge-button--disabled):not(.obridge-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c6:active:not(:disabled):not(.obridge-button--disabled):not(.obridge-button--disabled) {
      opacity: 0.85;
    ...
    .c16:hover:not(:disabled):not(.obridge-button--disabled):not(.obridge-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c16:active:not(:disabled):not(.obridge-button--disabled):not(.obridge-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              class="c16"
              href="https://docs.obridge.finance/get-started/connection-guide"
