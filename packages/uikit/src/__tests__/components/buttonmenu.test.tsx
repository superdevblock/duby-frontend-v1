...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c1:hover:not(:disabled):not(.obridge-button--disabled):not(.obridge-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c1:active:not(:disabled):not(.obridge-button--disabled):not(.obridge-button--disabled) {
      opacity: 0.85;
