/**
 * @see https://github.com/obridge/obridge-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://obridge.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://obridgebunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
