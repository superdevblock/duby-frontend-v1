...
import { Button, Text, Link, HelpIcon, Message, MessageText } from '@obridge/uikit'
...
const WalletWrongNetwork: React.FC<React.PropsWithChildren<WalletWrongNetworkProps>> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <StyledLink href="https://docs.obridge.finance/get-started/connection-guide" external>
