...
import { Text, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher } from '@obridge/uikit'
import {
  useExpertModeManager,
  useSubgraphHealthIndicatorManager,
  useUserExpertModeAcknowledgementShow,
} from 'state/user/hooks'
import { useSwapActionHandlers } from 'state/aaa-swap/useSwapActionHandlers'
          ...
          <>
            ...
            <Flex justifyContent="space-between" alignItems="center" mb="24px">
              <Flex alignItems="center">
                ...
                <QuestionHelper
                  text={t('Fun sounds to make a truly immersive obridge-flipping trading experience')}
                  placement="top-start"
                  ml="4px"
                />
              </Flex>
              <OBridgeToggle checked={audioPlay} onChange={toggleSetAudioMode} scale="md" />
            </Flex>
            */}
          </>
        )}
