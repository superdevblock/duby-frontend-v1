...
import { Button, CheckmarkIcon, CogIcon, Input, LinkExternal, Text, Toggle, useTooltip } from '@obridge/uikit'
...
import { useFetchListCallback } from '@obridge/token-lists'
  ...
  const sortedLists = useMemo(() => {
    ...
    return listUrls
      ...
      .sort((u1, u2) => {
        ...
        if (l1 && l2) {
          // Always make OBridge list in top.
          const keyword = 'obridge'
