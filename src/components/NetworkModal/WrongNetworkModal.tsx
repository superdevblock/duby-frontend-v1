...
import { ArrowForwardIcon, Button, Grid, Message, MessageText, Modal, Text } from '@obridge/uikit'
    ...
    <Modal title={t('You are in wrong network')} onDismiss={onDismiss}>
      <Grid style={{ gap: '16px' }} maxWidth="336px">
        ...
        <div style={{ textAlign: 'center' }}>
          <Image width={184} height={140} src="/images/wrong-network.png" alt="check your network" />
        </div>
