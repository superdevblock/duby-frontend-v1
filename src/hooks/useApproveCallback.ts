...
import { Currency, CurrencyAmount, Trade, TradeType } from '@obridge/sdk'
...
export function useApproveCallbackFromTrade(chainId: number, amountToApprove: CurrencyAmount<Currency>) {
