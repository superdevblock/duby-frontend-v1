...
import { EMPTY_LIST, TokenAddressMap, WrappedTokenInfo } from '@obridge/tokens'
...
import { ListsState } from '@obridge/token-lists'
import uniqBy from 'lodash/uniqBy'
import { useMemo } from 'react'
import { UNSUPPORTED_LIST_URLS, WARNING_LIST_URLS } from '../../config/constants/lists'
import DEFAULT_TOKEN_LIST from '../../config/constants/tokenLists/obridge-default.tokenlist.json'
import UNSUPPORTED_TOKEN_LIST from '../../config/constants/tokenLists/obridge-unsupported.tokenlist.json'
import WARNING_TOKEN_LIST from '../../config/constants/tokenLists/obridge-warning.tokenlist.json'
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    [ChainId.DYNO]: { ...map1[ChainId.DYNO], ...map2[ChainId.DYNO] },
    [ChainId.DYNO_TESTNET]: { ...map1[ChainId.DYNO_TESTNET], ...map2[ChainId.DYNO_TESTNET] },
  }
}
