import { ChainId, Pair, Token } from '@obridge/sdk'
import { deserializeToken } from '@obridge/tokens'
import { differenceInDays } from 'date-fns'
import flatMap from 'lodash/flatMap'
import { getFarmConfig } from '@obridge/farms/constants'
...
import { useWeb3LibraryContext } from '@obridge/wagmi'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Cake-LP', 'OBridge LPs')
}
