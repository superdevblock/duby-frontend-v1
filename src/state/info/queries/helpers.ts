...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, OBridgeDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | OBridgeDayData): ChartEntry => ({
