import { Currency, CurrencyAmount, Fraction, JSBI, Percent, Trade, TradeType } from '@obridge/sdk'
import IOBridgeRouter02ABI from 'config/abi/IOBridgeRouter02.json'
import {
...
import { Field } from '../state/aaa-swap/actions'
...
export function useRouterContract() {
  ...
  return useContract(ROUTER_ADDRESS[chainId], IOBridgeRouter02ABI, true)
}
