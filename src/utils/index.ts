...
import { ChainId, Currency } from '@obridge/sdk'
import { bsc } from '@obridge/wagmi/chains'
import memoize from 'lodash/memoize'
import { TokenAddressMap } from '@obridge/tokens'
...
export function getBlockExploreLink(
  ...
  const chain = chains.find((c) => (c.id * 1) === (chainId * 1))
