...
import { CAKE } from '@obridge/tokens'

// Addresses
import {
  getAddress,
  getOBridgeProfileAddress,
  getOBridgeBunniesAddress,
...
// ABI
import profileABI from 'config/abi/obridgeProfile.json'
import obridgeBunniesAbi from 'config/abi/obridgeBunnies.json'
...
import obridgeSquadAbi from 'config/abi/obridgeSquad.json'
...
export const getProfileContract = (signer?: Signer | Provider) => {
  // @ts-ignore
  return getContract({ abi: profileABI, address: getOBridgeProfileAddress(), signer }) as OBridgeProfile
}
export const getOBridgeBunniesContract = (signer?: Signer | Provider) => {
  // @ts-ignore
  return getContract({ abi: obridgeBunniesAbi, address: getOBridgeBunniesAddress(), signer }) as OBridgeBunnies
}
...
export const getOBridgeSquadContract = (signer?: Signer | Provider) => {
  // @ts-ignore
  return getContract({ abi: obridgeSquadAbi, address: getOBridgeSquadAddress(), signer }) as OBridgeSquad
}
