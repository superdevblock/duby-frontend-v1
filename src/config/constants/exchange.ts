import { ChainId, JSBI, Percent, Token, WNATIVE } from '@obridge/sdk'
import { BigNumber } from '@ethersproject/bignumber'
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH } from '@obridge/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.RINKEBY]: '',
  [ChainId.GOERLI]: '',
  [ChainId.BSC]: '0xd8dB8626EBcfCad0633037E579B58667DeF6d098',
  [ChainId.BSC_TESTNET]: '0x7BAD5F84AC5Ef7bfd41587BC792F39236855193C',
  [ChainId.DYNO]: '0x8BD3CE58362074bf1aF429D4eb9398c17d614597',
  [ChainId.DYNO_TESTNET]: '0x6EdBCB6a5c9396ae060ef2C8EC4947838493ffe9',
}
...
export const GELATO_HANDLER = 'obridge'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://docs.obridge.finance/products/obridge-exchange/limit-orders'
