import { ErrorIcon, Flex, Text } from '@obridge/uikit'
...
const BridgeCallbackErrorInnerAlertTriangle = styled.div`
  background-color: ${({ theme }) => `${theme.colors.failure33}`};
  display: flex;
  align-items: center;
  justify-content: center;
...
export function BridgeCallbackError({ error }: { error: string }) {
  return (
    <BridgeCallbackErrorInner>
      <BridgeCallbackErrorInnerAlertTriangle>
...
export const BridgeShowAcceptChanges = styled(AutoColumn)`
